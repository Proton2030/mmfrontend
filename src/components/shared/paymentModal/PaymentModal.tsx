      ...
      <View style={styles.modalContent}>
        ...
        <View style={styles.subscriptionRow}>
          <Card style={styles.subscriptionCard}>
            ...
            <Button style={{ marginTop: 20, padding: 0 }} mode="contained" onPress={() => handlePaymentUpdate(0)}>
              pay
            </Button>
          </Card>
          ...
          <Card style={styles.subscriptionCard}>
            ...
            <Button style={{ marginTop: 20, padding: 0 }} mode="contained" onPress={() => handlePaymentUpdate(1)}>
              pay
            </Button>
          </Card>
          ...
          <Card style={styles.subscriptionCard}>
            ...
            <Button style={{ marginTop: 20 }} mode="contained" onPress={() => handlePaymentUpdate(2)}>
              pay
            </Button>
          </Card>
        </View>
