...
const SelectFieldBottomSheet = ({ isVisible, onClose, options, onOptionSelect, groupField, language, setSelectItem }: any) => {
        ...
        >
            <View style={styles.overlay}>
                <View style={[styles.bottomSheetContainer, { backgroundColor: colors.surfaceVariant }]}>
                    ...
                    <Button onPress={onClose} mode="contained" style={styles.closeButton} contentStyle={{ paddingVertical: 5 }} textColor='white'>
                        Close
                    </Button>
                </View>
            </View>
