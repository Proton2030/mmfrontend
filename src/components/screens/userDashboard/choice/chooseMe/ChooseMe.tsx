    ...
    return (
        <SafeAreaView style={{ padding: 10 }}>
            <FlatList
                ...
                data={choiceList}
                renderItem={({ item }) => <ChoiceMatchCard status='CHOICE-ME' name={item.choice_user_details.full_name} state={item.choice_user_details.state} />} // Assuming addChoice is defined
