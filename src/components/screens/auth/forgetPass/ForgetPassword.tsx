    ...
    return (
        <>
            <ScrollView style={globalStyles.parent} contentContainerStyle={globalStyles.parentScrollContainer}>
                ...
                {
                    screen === 0 ?
                        <SignUpScreenOne userDetails={userCredentials} handleChangeText={handleChangeText} handleChangeScreen={handleChangeScreen} loading={loading} mode='FORGET' /> : null
                }
                {
                    screen === 1 ?
                        <SignUpScreenTwo userDetails={userCredentials} handleChangeText={handleChangeText} handleChangeScreen={handleChangeScreen} otp={otp} /> : null
                }
                {
                    screen === 2 ?
                        <SignUpScreenThree userDetails={userCredentials} handleChangeText={handleChangeText} handleChangeScreen={handleChangeScreen} mode='FORGET' /> : null
                }
            </ScrollView>
            <SnackbarAlert message='Account Does Not Exist,Please Signup' onDismissSnackBar={onDismissSnackBar} visible={visible} key={0} />
        </>
    )
}
