...
const SignUpScreenOne = ({ handleChangeScreen, handleChangeText,userDetails }: ISignupScreenProps) => {
    ...
    return (
        <View>
            ...
            <View style={globalStyles.childContainer}>
                ...
                <Button mode='contained' style={globalStyles.pinkButton} onPress={handleGenerateOtpClick}>Generate OTP</Button>
            </View>
        </View>
    )
}
