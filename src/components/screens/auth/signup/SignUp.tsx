...
const SignUp = () => {
    ...
    return (
        <ScrollView style={globalStyles.parent} contentContainerStyle={globalStyles.parentScrollContainer}>
            ...
            {
                screen === 0 ?
                    <SignUpScreenOne userDetails={userDetails} handleChangeText={handleChangeText} handleChangeScreen={handleChangeScreen} /> : null
            }
            {
                screen === 1 ?
                    <SignUpScreenTwo userDetails={userDetails} handleChangeText={handleChangeText} handleChangeScreen={handleChangeScreen} /> : null
            }
            {
                screen === 2 ?
