...
const SupportContainer = () => {
    ...
    return (
        <View style={globalStyles.childContainer}>
            {user?.gender === "MALE" ? (
                <>
                    <InlineCard icon='phone-call' titleKey='Phone 2 ' onClick={handleCall} value='+880 1873405728' buttonIcon='phone' />
                    <InlineCard icon='phone-call' titleKey='Phone 2 ' onClick={handleCall} value='+880 1857237427' buttonIcon='phone' />
                    <InlineCard icon='mail' titleKey='Email ' onClick={handleEmailButtonPress} value='muslimmatrimonys@g...' buttonIcon='gmail' />
                </>
            ) : (
                <>
                    <InlineCard icon='phone-call' titleKey='Phone 1 ' onClick={handleCall} value='+880 1897686637' buttonIcon='phone' />
                    <InlineCard icon='phone-call' titleKey='Phone 2 ' onClick={handleCall} value='+880 1857237427' buttonIcon='phone' />
                    <InlineCard icon='mail' titleKey='Email ' onClick={handleEmailButtonPress} value='muslimmatrimonys@g...' buttonIcon='gmail' />
                </>
            )}
