...
import { List, Avatar, Title, Caption, Divider, Appbar, useTheme } from 'react-native-paper';
      ...
      <ScrollView style={styles.scrollContainer}>
        ...
        <List.Section style={styles.listSection}>
          <TouchableOpacity onPress={() => handlePress('ResetPassord')}>
            <List.Item title="Reset Password" left={() => <List.Icon icon="lock-reset" />} />
          </TouchableOpacity>

          <TouchableOpacity onPress={() => handlePress('Reset Email')}>
            <List.Item title="Reset Email" left={() => <List.Icon icon="email-edit-outline" />} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handlePress('Delete Account')}>
            <List.Item title="Delete Account" left={() => <List.Icon icon="account-remove" />} />
          </TouchableOpacity>

          <TouchableOpacity onPress={() => handlePress('Block User')}>
            <List.Item title="Block User" left={() => <List.Icon icon="account-lock" />} />
          </TouchableOpacity>
        </List.Section>
      </ScrollView>
    </View>
