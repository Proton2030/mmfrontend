    ...
    <>
      ...
      >
        ...
        <View style={globalStyles.childContainer}>
          ...
          <Button mode="contained" style={[globalStyles.pinkButton, { marginBottom: 18 }]} onPress={handleChangeScreen}>
            Next
          </Button>
          {screen !== 0 ? (
            <Button mode="outlined" style={globalStyles.lightPinkButton} onPress={handleBackScreen}>
              Back
            </Button>
          ) : null}
        </View>
